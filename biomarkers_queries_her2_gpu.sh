...
srun -c 20 --mem-per-cpu=10G --gres disk:512,gpu:v100:4 --exclusive python3 $SCRIPT --cuda --data $DATA --keywords $KEYWORDS --layout $LAYOUT --mode $MODE_HER2 --model $MODEL --pickle $PICKLE_HER2 --port $PORT --tokenizer $TOKENIZER