...
srun -c 20 --mem-per-cpu=10G --exclusive python3 $SCRIPT --data $DATA --keywords $KEYWORDS --mode $MODE_PR --model $MODEL --pickle $PICKLE_PR --port $PORT --tokenizer $TOKENIZER
